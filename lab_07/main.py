...
class App():
    def __init__(self) -> None:
        ...
        self.canv.bind('<Button-3>', self.set_cutterMouse)
        ...
        self.canv.bind('<Button-1>', self.add_pointMouse)
    ...
    def prog_info(self):
        messagebox.showinfo(title='О программе', message='Реализация алгоритма отсечения отрезка регулярным отсекателем.\n'
